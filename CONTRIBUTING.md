...
`$GOPATH/src/github.com/serjplus/cosmos-sdk `, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

  - Create the fork on github, using the fork button.
  - Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/serjplus/cosmos-sdk`)
...
### Development Procedure
  ...
  - create a development branch either on github.com/serjplus/cosmos-sdk, or your fork (using `git remote add origin`)
