...
import (
	...
	"github.com/serjplus/cosmos-sdk/x/auth/client"
	"github.com/serjplus/cosmos-sdk/x/auth/types"
	genutilrest "github.com/serjplus/cosmos-sdk/x/genutil/client/rest"
)
...
func QueryAccountRequestHandlerFn(storeName string, cliCtx context.CLIContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			...
			// Ref: https://github.com/serjplus/cosmos-sdk/issues/4923
